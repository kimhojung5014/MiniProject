...
public class SmartPhone{
	...
	public Contact inputContactData(int select) {
			...
			contact = new CompanyContact(name, number, index, email, birth, group, companyName, departmentName, position);
			}
			else if(select==2) {
			...
			System.out.print("직급: ");
			String position = scanner.next();
			contact = new CustomerContact(name, number, index, email, birth, group, accountName, itemName, position);
			}
			return contact;
	}
